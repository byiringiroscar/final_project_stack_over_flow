...
class FriendRequest(models.Model):
    ...
    readed_request = models.BooleanField(default=False)
...
class GroupMessage(models.Model):
    ...
    def __str__(self):
        return f'{self.author.username} in {self.body}'
    ...
    def get_time_created(self):
        return self.created.astimezone().strftime('%H:%M')  # Convert to local timezone
