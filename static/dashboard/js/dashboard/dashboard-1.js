...
(function($) {
 ...
 var dlabChartlist = function(){
	...
	var pieChart1 = function(data){
		...
		colors:['#0c85d0', '#af5d18', '#8c43ff', '#9d0621', '#0b2e13'],
		legend: {
              position: 'bottom',
			  show:false
            },
...
const getChartData=()=>{
		fetch('/user_admin/skills_stat').then((res)=>res.json().then((results)=>{

			const category_skills = results.skills_stat;
			const [labels, data] = [Object.keys(category_skills),
				Object.values(category_skills)];
			pieChart1(data);
		}));
};
