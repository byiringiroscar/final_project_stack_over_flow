...
class Profile(models.Model):
    ...
    backend_development = models.PositiveIntegerField(null=True, blank=True, default=0)
    frontend_development = models.PositiveIntegerField(null=True, blank=True, default=0)
    hardware = models.PositiveIntegerField(null=True, blank=True, default=0)
